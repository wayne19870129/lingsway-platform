...
> 刚推上去还没合并的东西看不到（见 §1）。
>
> 最后更新：2026-09-19（**S07 规格闭包修正，派发阻塞已解除，见 §5.0**；
...
| 任务 | 状态 |
|---|---|
| **S07** 订单队列计费（续费/加购） | **下一个要派的任务**，派给 Codex 桌面版。**这个 PR 要打 `no-automerge`，由 User 人工合**——理由见下。**2026-09-19：曾因规格自相矛盾派不出去，已修正，现在可以派** |
